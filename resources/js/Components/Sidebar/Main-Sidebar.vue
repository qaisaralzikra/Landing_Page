                ...
                >
                    ...
                    <div>
                        ...
                        <form @submit.prevent="submit" >
                            <div
                                id="kt_drawer_example_advanced_1"
                                class="bg-body"
                                data-kt-drawer="true"
                                data-kt-drawer-activate="true"
                                data-kt-drawer-toggle="#kt_drawer_example_advanced_button_1"
                                data-kt-drawer-close="#kt_drawer_example_advanced_close_1"
...
const drawerCloseBtndaerah = document.querySelector(
    "#kt_drawer_example_advanced_close_1"
);
...
const submit = () => {
    const submitBtn = document.querySelector("#kt_drawer_submit_button_1");
    if (submitBtn) {
